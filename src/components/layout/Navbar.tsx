            ...
            <div className="flex items-center gap-12">
              ...
              <Link href="/" className="group flex items-center gap-3">
                <div className="relative flex items-center justify-center">
                  <Moon className="h-6 w-6 text-accent transition-transform group-hover:rotate-12" />
                ...
                <div className="flex flex-col">
                  <span className="text-2xl font-serif font-black tracking-[0.2em] text-primary group-hover:text-accent transition-colors leading-none">
                    LUNA
                  </span>
                  <span className="text-[8px] font-sans font-black tracking-[0.4em] opacity-40 uppercase mt-1">Boutique</span>
                </div>
              </Link>
